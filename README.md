...
В некоторых случаях возникает необходимость в установке собственнго ядра. Например, для использования нового функционала, не включенного в основную веткую
